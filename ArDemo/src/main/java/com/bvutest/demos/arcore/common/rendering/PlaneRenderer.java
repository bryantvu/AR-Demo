...
public class PlaneRenderer {
  ...
  public void createOnGlThread(Context context, String gridDistanceTextureName) throws IOException {
    ...
    GLES20.glUseProgram(planeProgram);
      ...
      com.bvutest.demos.arcore.common.rendering.ShaderUtil.checkGLError(TAG, "Program creation");
    ...
    GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, 0);
      ...
      com.bvutest.demos.arcore.common.rendering.ShaderUtil.checkGLError(TAG, "Texture loading");
    ...
    planeUvMatrixUniform = GLES20.glGetUniformLocation(planeProgram, "u_PlaneUvMatrix");
      ...
      com.bvutest.demos.arcore.common.rendering.ShaderUtil.checkGLError(TAG, "Program parameters");
  }
  ...
  private void draw(float[] cameraView, float[] cameraPerspective, float[] planeNormal) {
    ...
    GLES20.glDrawElements(
      ...
      com.bvutest.demos.arcore.common.rendering.ShaderUtil.checkGLError(TAG, "Drawing plane");
  }
  ...
  public void drawPlanes(Collection<Plane> allPlanes, Pose cameraPose, float[] cameraPerspective) {
    ...
    GLES20.glEnableVertexAttribArray(planeXZPositionAlphaAttribute);
      ...
      com.bvutest.demos.arcore.common.rendering.ShaderUtil.checkGLError(TAG, "Setting up to draw planes");
    ...
    GLES20.glClearColor(0.1f, 0.1f, 0.1f, 1.0f);
      ...
      com.bvutest.demos.arcore.common.rendering.ShaderUtil.checkGLError(TAG, "Cleaning up after drawing planes");
  }
