...
public class BackgroundRenderer {
  ...
  public void createOnGlThread(Context context, int depthTextureId) throws IOException {
    ...
    {
      int vertexShader =
              com.bvutest.demos.arcore.common.rendering.ShaderUtil.loadGLShader(TAG, context, GLES20.GL_VERTEX_SHADER, CAMERA_VERTEX_SHADER_NAME);
      int fragmentShader =
  ...
  private void draw(boolean debugShowDepthMap) {
    ...
    com.bvutest.demos.arcore.common.rendering.ShaderUtil.checkGLError(TAG, "BackgroundRendererDraw");
  }
