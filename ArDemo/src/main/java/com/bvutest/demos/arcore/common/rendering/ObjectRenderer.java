...
public class ObjectRenderer {
  ...
  public void createOnGlThread(Context context, String objAssetName, String diffuseTextureAssetName)
    ...
    com.bvutest.demos.arcore.common.rendering.ShaderUtil.checkGLError(TAG, "OBJ buffer load");
  ...
  private void compileAndLoadShaderProgram(Context context) throws IOException {
    ...
    final int fragmentShader =
            com.bvutest.demos.arcore.common.rendering.ShaderUtil.loadGLShader(
  ...
  public void draw(
    ...
    com.bvutest.demos.arcore.common.rendering.ShaderUtil.checkGLError(TAG, "After draw");
  }
