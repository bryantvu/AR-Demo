 ...
 */
package com.bvutest.demos.arcore.common.rendering;
...
public class PointCloudRenderer {
   ...
   */
  public void createOnGlThread(Context context) throws IOException { com.bvutest.demos.arcore.common.rendering.ShaderUtil.checkGLError(TAG, "before create");
    ...
    GLES20.glBindBuffer(GLES20.GL_ARRAY_BUFFER, 0);
      ...
      com.bvutest.demos.arcore.common.rendering.ShaderUtil.checkGLError(TAG, "buffer alloc");

    int vertexShader =
            com.bvutest.demos.arcore.common.rendering.ShaderUtil.loadGLShader(TAG, context, GLES20.GL_VERTEX_SHADER, VERTEX_SHADER_NAME);
    int passthroughShader =
            com.bvutest.demos.arcore.common.rendering.ShaderUtil.loadGLShader(TAG, context, GLES20.GL_FRAGMENT_SHADER, FRAGMENT_SHADER_NAME);
    ...
    GLES20.glUseProgram(programName);
      ...
      com.bvutest.demos.arcore.common.rendering.ShaderUtil.checkGLError(TAG, "program");
    ...
    pointSizeUniform = GLES20.glGetUniformLocation(programName, "u_PointSize");
      ...
      com.bvutest.demos.arcore.common.rendering.ShaderUtil.checkGLError(TAG, "program  params");
  }
  ...
  public void update(PointCloud cloud) {
    if (cloud.getTimestamp() == lastTimestamp) {
      ...
      com.bvutest.demos.arcore.common.rendering.ShaderUtil.checkGLError(TAG, "before update");
    ...
    GLES20.glBindBuffer(GLES20.GL_ARRAY_BUFFER, 0);
      ...
      com.bvutest.demos.arcore.common.rendering.ShaderUtil.checkGLError(TAG, "after update");
  }
  ...
  public void draw(float[] cameraView, float[] cameraPerspective) {
    ...
    Matrix.multiplyMM(modelViewProjection, 0, cameraPerspective, 0, cameraView, 0);
      ...
      com.bvutest.demos.arcore.common.rendering.ShaderUtil.checkGLError(TAG, "Before draw");
    ...
    GLES20.glBindBuffer(GLES20.GL_ARRAY_BUFFER, 0);
      ...
      com.bvutest.demos.arcore.common.rendering.ShaderUtil.checkGLError(TAG, "Draw");
  }
}
