...
package com.bvutest.demos.java.body3d;
...
import com.bvutest.demos.common.DisplayRotationManager;
import com.bvutest.demos.java.body3d.rendering.BodyRenderManager;
...
public class BodyActivity extends Activity {
    ...
    /**
     * Check whether HUAWEI AR Engine server (com.bvutest.service) is installed on the current device.
    ...
    private boolean arEngineAbilityCheck() {
        ...
        if (!isInstallArEngineApk) {
            startActivity(new Intent(this, com.bvutest.demos.common.ConnectAppMarketActivity.class));
